            ...
            <form class="bg-white" method="post">
                ...
                <div class="row section-padding main-row">
                    <?php foreach($cols as $col) {
                        if ($col['name'] === 'id' || $col['name'] === 'contents' || $col['name'] === 'timestamp') continue;
                        ?>
                    ...
                    <div class="col-sm-12 col-xs-12 col">
                        <label for="contents">푸시내용</label>
                        <textarea name="contents" id="contents" class="form-control" placeholder="푸시내용" rows="10"><?php echo $row['contents']?></textarea>
                    </div>
                </div>
                <div class="bg-offwhite section-padding clearfix">
                    ...
                    <div class="pull-right btn-group">
                        ...
                        <?php if ($id !== null) { ?>
                        <a class="btn btn-sm btn-primary" href="/<?php echo $uris[1]?>/send/<?php echo $row['id']?>?<?php echo $qstr?>">
