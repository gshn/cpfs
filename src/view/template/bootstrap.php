...
<div class="container">
    <div class="p-3">
        ...
        <h2 class="py-1">h2 1.875rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h2>
        <h3 class="py-1">h3 1.640625rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h3>
        <h4 class="py-1">h4 1.40625rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h4>
        <h5 class="py-1">h5 1.171875rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h5>
        <h6 class="py-1">h6 0.9375rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h6>
    ...
    <div class="p-3">
        <h1 class="py-1 font-weight-100">weight-100(light)</h1>
        <h1 class="py-1 font-weight-100">h1 2.34375rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h1>
        <h2 class="py-1 font-weight-100">h2 1.875rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h2>
        <h3 class="py-1 font-weight-100">h3 1.640625rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h3>
        <h4 class="py-1 font-weight-100">h4 1.40625rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h4>
        <h5 class="py-1 font-weight-100">h5 1.171875rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h5>
        <h6 class="py-1 font-weight-100">h6 0.9375rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h6>
        <p class="py-1 font-weight-100">p 1rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</p>
        <small class="py-1 font-weight-100">small 0.8rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</small>
    </div>
    <div class="p-3">
        <h1 class="py-1 font-weight-700">weight-700(bold)</h1>
        <h1 class="py-1 font-weight-700">h1 2.34375rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h1>
        <h2 class="py-1 font-weight-700">h2 1.875rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h2>
        <h3 class="py-1 font-weight-700">h3 1.640625rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h3>
        <h4 class="py-1 font-weight-700">h4 1.40625rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h4>
        <h5 class="py-1 font-weight-700">h5 1.171875rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h5>
        <h6 class="py-1 font-weight-700">h6 0.9375rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h6>
        <p class="py-1 font-weight-700">p 1rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</p>
        <small class="py-1 font-weight-700">small 0.8rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</small>
    </div>
    <div class="p-3">
        <h1 class="py-1 font-weight-900">weight-900(extra bold)</h1>
        <h1 class="py-1 font-weight-900">h1 2.34375rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h1>
        <h2 class="py-1 font-weight-900">h2 1.875rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h2>
        <h3 class="py-1 font-weight-900">h3 1.640625rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h3>
        <h4 class="py-1 font-weight-900">h4 1.40625rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h4>
        <h5 class="py-1 font-weight-900">h5 1.171875rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h5>
        <h6 class="py-1 font-weight-900">h6 0.9375rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</h6>
        <p class="py-1 font-weight-900">p 1rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</p>
        <small class="py-1 font-weight-900">small 0.8rem 동해물과 백두산이 마르고 닳도록 ABCDEFG abcdefg</small>
    </div>
